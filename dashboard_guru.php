...
.dist-label { width: 130px; font-size: 13px; flex-shrink: 0; }
.dist-bar-wrap { flex: 1; background: #f0f0f0; border-radius: 6px; height: 20px; overflow: hidden; }
.dist-bar { height: 100%; border-radius: 6px; transition: width 0.5s ease; }
.dist-count { font-size: 13px; font-weight: 700; width: 30px; text-align: right; flex-shrink: 0; }
...
.tipe-login      { background: #e8f4fd; color: #0f3460; }
.tipe-pretest    { background: #fff3e0; color: #e67e22; }
.tipe-buka_materi { background: #e8f8e8; color: #1a7a1a; }
.tipe-jawab_quiz { background: #f3e8ff; color: #7b2cbf; }
.tipe-selesai_materi { background: #d4edda; color: #155724; }
.empty-state {
    text-align: center;
    padding: 40px;
    color: #aaa;
