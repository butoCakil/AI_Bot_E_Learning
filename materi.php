...
.topik-nav a:hover { background: #f0f7ff; }
.topik-nav a.aktif {
    background: #e8f4fd;
    color: #0f3460;
    font-weight: 600;
...
.konten-nav a:hover { background: #f8f8f8; }
.konten-nav a.aktif {
    background: #e8f4fd;
    color: #0f3460;
    font-weight: 600;
...
.tipe-teori     { background: #e8f4fd; color: #0f3460; }
.tipe-langkah   { background: #e8f8e8; color: #1a7a1a; }
.tipe-evaluasi  { background: #fff3e0; color: #e67e22; }
.tipe-jobsheet  { background: #f3e8ff; color: #7b2cbf; }
.tipe-tantangan { background: #fde8e8; color: #c0392b; }
.wajib-icon { color: #e74c3c; font-size: 10px; }
...
.content-body table td { padding: 9px 12px; border-bottom: 1px solid #eee; }
.content-body table tr:nth-child(even) td { background: #f8f8f8; }
.content-body strong { color: #0f3460; }
...
.opsi-list label:hover { border-color: #e67e22; background: #fff8f0; }
.opsi-list input[type="radio"] { accent-color: #e67e22; }
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-card">
            ...
            <nav class="topik-nav">
                ...
                <a href="materi.php?topik=<?= $slug ?>"
                   class="<?= $slug === $topik_aktif ? 'aktif' : '' ?>">
    ...
    <div class="main">
        ...
        <div class="content-card">
            <div class="content-meta">
                <span class="tipe-badge tipe-<?= $konten_aktif['tipe'] ?>"><?= strtoupper($konten_aktif['tipe']) ?></span>
        ...
        <div class="nav-buttons">
            ...
            <?php if ($next_id): ?>
                <a href="materi.php?topik=<?= $topik_aktif ?>&konten=<?= $next_id ?>" class="btn btn-primary">Selanjutnya →</a>
            <?php else: ?>
